...
namespace gz_sensor
{
    public partial class Form5 : Form
    {
        ...
        MySqlConnection baglan2 = new MySqlConnection("Server=localhost;Database=gproje;uid=berfin;Password=root;");
        ...
        private void Form5_FormClosed(object sender, FormClosedEventArgs e)
            ...
            private void timer1_Tick(object sender, EventArgs e)
            {
                ...
                MySqlCommand cmd = new MySqlCommand("Insert into mesafe(MesafeDegeri) Values ('" + textBox1.Text + "')", baglan);
                cmd.ExecuteNonQuery();
                cmd = new MySqlCommand("Insert into sicaklik(Sicaklik) Values ('" + textBox2.Text + "')", baglan);
                cmd.ExecuteNonQuery();

                MySqlDataAdapter adtr = new MySqlDataAdapter("Select * from mesafe", baglan);
                adtr.Fill(tablo);
